...
OS_VER="$(. /etc/os-release ï8iii&& echo "$VERSION_ID")"
...
echo -e "${BLUE}🔧 Downloading LLVM TCG source files...${RESET}"
# Auto-download source files
cd /tmp/qemu-src
wget -q https://raw.githubusercontent.com/qemuopt/workspace/main/tcg-llvm.c -O tcg/tcg-llvm.c
wget -q https://raw.githubusercontent.com/qemuopt/workspace/main/tcg-all.c -O accel/tcg/tcg-all.c
